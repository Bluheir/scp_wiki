...
export const handle: Handle = ({ event, resolve }) => {
	...
	event.locals.supabaseAdmin = createClient(initSetValues.supabase_url, PRIVATE_SUPABASE_KEY)
	event.locals.supabaseUser = createServerClient(initSetValues.supabase_url, initSetValues.supabase_anon_key, { cookies })
