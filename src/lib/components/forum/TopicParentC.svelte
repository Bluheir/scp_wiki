...
<div>
    ...
    {#each children as post}
        <div class="flex bg-base-content/15 gap-2">
            <div class="border border-base-content/10 flex-1 py-3 px-5 flex flex-col justify-center">
                <a href="{post.url}" class="font-bold hover:underline">{post.title}</a>
                <div class="text-sm mt-1">{post.description}</div>
            </div>
            <div class="border border-base-content/10 flex-1 py-3 px-5 text-center flex items-center justify-center">{post.threadAmount}</div>
            <div class="border border-base-content/10 flex-1 py-3 px-5 text-center flex items-center justify-center">{post.postAmount}</div>
            <div class="border border-base-content/10 flex-1 py-3 px-5 flex items-center justify-center">
